    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-card border border-border backdrop-blur-xl hover:bg-muted/30 transition-all duration-500 hover:scale-105 hover:border-emerald-400/50 group cursor-pointer"
              >
                <CardHeader className="p-8">
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-14 h-14 bg-muted rounded-2xl flex items-center justify-center group-hover:bg-emerald-400/20 transition-colors">
                  ...
                  <CardDescription className="text-muted-foreground text-base leading-relaxed group-hover:text-foreground transition-colors">
                    {feature.description}
                  </CardDescription>
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <Card className="bg-card border border-border backdrop-blur-xl overflow-hidden">
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 border-r border-border">
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="block text-sm font-medium mb-3 text-muted-foreground">Resume Upload</label>
                      <div className="border-2 border-dashed border-border rounded-xl p-8 text-center hover:border-emerald-400/50 transition-colors cursor-pointer group">
                        <FileText className="w-12 h-12 mx-auto mb-4 text-muted-foreground group-hover:text-emerald-400 transition-colors" />
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-3 text-muted-foreground">Job Description</label>
                      <Textarea
                        placeholder="Paste the job description here..."
                        className="min-h-[120px] bg-muted border-border text-foreground placeholder:text-muted-foreground focus:border-emerald-400/50"
                    ...
                    <Button className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-primary-foreground font-semibold py-3">
                      Generate Questions
                ...
                {/* Output Section */}
                <div className="p-8 bg-gradient-to-br from-muted to-transparent">
                  <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="bg-card border border-border backdrop-blur-xl text-center hover:bg-muted/30 transition-all duration-300 hover:scale-105"
              >
      ...
      {/* Login Modal */}
      {/* Footer */}
      <footer className="relative z-10 border-t border-border bg-background/80 backdrop-blur-xl py-12 px-6">
        <div className="container mx-auto">
